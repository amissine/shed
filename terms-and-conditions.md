# Terms and Conditions for Stellar Help Exchange (SHEX)
...
**Application** refers to SHEX Lab, accessible from [https://shed.didalik.workers.dev](https://shed.didalik.workers.dev).

**Country** refers to: United Kingdom

**Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SHEX Labs, London, UK.

**Device** means any device that can access the Service such as a computer, a cellphone or a digital tablet.

**Service** refers to SHEX Lab, accessible from [https://shed.didalik.workers.dev](https://shed.didalik.workers.dev).

**Terms and Conditions** (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.

**Third-party Social Media Service** means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.

**Website** refers to SHEX Lab, accessible from [https://shed.didalik.workers.dev](https://shed.didalik.workers.dev).
...
- By email: didalik.aim@gmail.com
